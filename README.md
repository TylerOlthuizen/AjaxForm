...
1. type: Define what HTTP verb we will want to use. In our case this is “post”
2. url: This will be the url where we want to post (www.mysite/sender.php)
3. data: This will be our Ajax data that we created.
4. dataType: The type of data we expect back from the server
